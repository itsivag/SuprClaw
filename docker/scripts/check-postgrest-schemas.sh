...
DOCKER_DIR="${DOCKER_DIR:-/opt/supabase/docker}"
...
usage() {
    cat <<'EOF'
Usage: check-postgrest-schemas.sh [--repair] [--docker-dir DIR] [--db-container NAME]

Options:
  --repair            Rewrite PGRST_DB_SCHEMAS in .env and recreate the rest service
  --docker-dir DIR    Supabase docker directory (default: /opt/supabase/docker)
